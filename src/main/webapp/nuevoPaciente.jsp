...
<div class="text-left">
    <h1 class="h3 text-gray-900 mb-3">Nuevo Paciente</h1>
</div>
...
<form class="user" action="SvPaciente" method="POST">
    ...
    <div class="form-group row">
        <div class="col-sm-3 mb-3 mb-sm-0">
            ...
            <select id="opcion" class="form-control" name="tieneObraSocial">
                <option value="false">No tiene Obra Social</option>
                <option value="true">Sí tiene Obra Social</option>
            </select>
        </div>
        <div class="col-sm-3">
            <br>
