...
<div class="text-left">
    <h1 class="h3 text-gray-900 mb-3">Nuevo Empleado</h1>
</div>
...
<form onsubmit="return validarFormulario()" action="SvEmpleado" method="POST">
    ...
    <!-- Tipo de Empleado (Secretario / Odontólogo) -->
    <div class="form-group row">
        <div class="col-sm-3">
            ...
            <div class="text-danger" id="error-tipoEmpleado"></div>

            <!--Para mostrar la ADVETENCIA/ERROR que viene desde el SERVLET, 
            en caso de que el script del JS falle o pase por alto algo-->
            <% if (errores != null && errores.containsKey("tipoEmpleado")) {%>
            <div class="text-danger"><%= errores.get("tipoEmpleado")%></div>
            <% }%>
        </div>
    </div>
