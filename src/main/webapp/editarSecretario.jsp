...
<div class="text-left">
    <h1 class="h3 text-gray-900 mb-3">Editar Secretario</h1>
</div>
...
<form class="user" id="form-editar-secretario">
    ...
    <div class="form-group row">
        <div class="col-sm-3 mb-3 mb-sm-0">
            ...
            <input type="text" class="form-control form-control-user" id="nombre"
                   name="nombre" placeholder="Nombre" value="<%=se.getNombre()%>">
        </div>
        <div class="col-sm-3">
            <label>Apellido:</label>
            <input type="text" class="form-control form-control-user" id="apellido"
                   name="apellido" placeholder="Apellido" value="<%=se.getApellido()%>">
        </div>
    </div>
    <br>
    <div class="form-group row">
        <div class="col-sm-3 mb-3 mb-sm-0">
            ...
            <select name="tipoDoc" class="form-control">
                <% for (TipoDocumento tipoDoc : listaTiposDocumentos) {
                        boolean seleccionado = tipoDoc.getIdTipoDocumento() == se.getTipoDocumento().getIdTipoDocumento();%>
        ...
        <div class="col-sm-3">
            ...
            <input type="text" class="form-control form-control-user" id="dni"
                   name="dni" placeholder="DNI" value="<%=se.getDni()%>">
        </div>
    </div>
    <br>
    <div class="form-group row">
        <div class="col-sm-3 mb-3 mb-sm-0">
            ...
            <input type="text" class="form-control form-control-user" id="telefono"
                   name="telefono" placeholder="Teléfono" value="<%=se.getTelefono()%>">
        </div>
        <div class="col-sm-3">
            <label>Dirección:</label>
            <input type="text" class="form-control form-control-user" id="direccion"
                   name="direccion" placeholder="Dirección" value="<%=se.getDireccion()%>">
        </div>
    </div>
    <br>
    <div class="form-group row">
        <div class="col-sm-3 mb-3 mb-sm-0">
            ...
            <% SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
                String fechaFormateada = sdf.format(se.getFecha_nac());%>
        ...
        <div class="col-sm-3">
            ...
            <select name="tipo_Sangre" class="form-control">
                <% for (TipoSangre tipo : listaTiposSangre) {
                        boolean seleccionado = tipo.getIdTipoSangre() == se.getTipoSangre().getIdTipoSangre();%>
        ...
        <div class="col-sm-3 mb-3 mb-sm-0">
            <div>
                ...
                <input type="text" class="form-control form-control-user" id="sector"
                       name="sector" placeholder="Sector" value="<%=se.getSector()%>">
            </div>
        ...
        <div class="col-sm-3">
            ...
            <select class="form-control" name="usuario">
                <% for (Usuario usu : listaUsuarios) {
                       boolean seleccionado  = usu.getIdUsuario()== se.getUsuario().getIdUsuario(); %>
...
<script>
    ...
    document.getElementById("form-editar-secretario").addEventListener("submit", function (event) {
        ...
        console.log(JSON.stringify(secretario)); // ⬅️ Acá lo ves
        ...
        fetch("SvSecretario", {
            ...
            body: JSON.stringify(secretario)
        })
                .then(res => {
                    if (res.ok) {
                        Swal.fire({
                            ...
                            icon: "success",
                            title: "Éxito",
                            text: "Secretario actualizado correctamente",
                        ...
                        Swal.fire({
                            icon: "error",
                            title: "Error",
                            text: "No se pudo actualizar el secretario",
