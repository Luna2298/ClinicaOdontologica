...
public class ControladoraLogica {
    ...
    public void crearUsuario(String nombreUsuario, String contra, Rol rol) {
 ...
 /*Cuando se EDITA: nombreUsuario, rol y contraseña*/
    public void editarUsuario(Usuario usu, String nombreUsuario, Rol rol,
            String nuevoHash) {

        usu.setNombreUsuario(nombreUsuario);
        usu.setTipoRol(rol);
        usu.setContrasenia(nuevoHash);

        controlPersis.editarUsuario(usu);

    }

    /*Cuando se EDITA: nombreUsuario y rol. SIN EDITAR LA CONTRASEÑA*/
    public void editarUsuario(Usuario usu, String nombreUsuario, Rol rol) {
        ...
        for (Usuario usu : listaUsuarios) {
            ...
            if (usu.getNombreUsuario().equals(usuario)) {
                ...
                if (usu.getContrasenia().equals(contra)) {
                    ...
                    validado = true;
                    break;
                    /*Si no pongo el break, el for sigue iterando hasta terminar.
                    Y jamas avisa que encontro al usuario y contraseña correcto*/
                    ...
                    break;
                    /*Si no pongo el break, el for sigue iterando hasta terminar.
                    Y mensaje siempre dara "El usuario no existe!" por mas 
                    que el Usuario SI EXISTA, pero la contrasenia NO COINCIDA.*/
                }
            } else {
    ...
    public Rol traerRol(int idRol) {
        ...
        return controlPersis.traerRol(idRol);
    }
